export const DEFAULT_SUB_PROJECTS = [
  {
    ...
    repo: 'https://github.com/bingak36/End-Word-Game',
  },
  {
    id: 'sp2',
    icon: '⏰',
    ...
    repo: 'https://github.com/bingak36/timer-app',
  },
  {
    id: 'sp3',
    icon: '🧭',
    ...
    repo: 'https://github.com/bingak36/Router',
  },
  {
    id: 'sp4',
    icon: '🌤️',
    ...
    repo: 'https://github.com/bingak36/Weather-api',
  },
  {
    id: 'sp5',
    icon: '📶',
    ...
    repo: 'https://github.com/bingak36/wifi-maps/tree/main-1',
  },
  {
    id: 'sp6',
    icon: '📖',
    ...
    repo: 'https://github.com/bingak36/emotion-diary/tree/main',
  },
  {
    id: 'sp7',
    icon: '📋',
    ...
    repo: 'https://github.com/bingak36/Todo-List',
  },
  {
    id: 'sp8',
    icon: '🚗',
    ...
    repo: 'https://github.com/bingak36/tocobo-clone-ver-tesla-copy',
  },
]
